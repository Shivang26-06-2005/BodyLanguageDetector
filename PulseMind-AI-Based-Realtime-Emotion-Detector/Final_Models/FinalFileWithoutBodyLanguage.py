...
class MultiModalEmotionDetector:
    ...
    def init_bart_feedback(self):
        ...
        try:
            ...
            print("[OK] BART feedback model loaded")
        except Exception as e:
    ...
    def detect_video_emotion_threaded(self, frame):
        ...
        # Create a copy to prevent thread buffer race condition
        ...
        def process():
            try:
                ...
                if results.multi_face_landmarks and len(results.multi_face_landmarks) > 0:
                    ...
                    # Fallback to Haar Cascade if face mesh is momentarily obstructed
                ...
                if box is not None:
                    ...
                    if sw > 20 and sh > 20:
                        ...
                        face_roi = gray_full[sy:sy+sh, sx:sx+sw]
    ...
    def detect_prosody_features_threaded(self):
        ...
        def process():
            try:
                ...
                # Extract accurate acoustic prosody features (pitch, intensity, tempo, pause_ratio, stress)
