...
class MultiModalEmotionDetector:
    ...
    def load_models(self):
        ...
        try:
            ...
            self.video_model.load_state_dict(torch.load('Final_Models/fer_model_finetuned_v3.pth', map_location=DEVICE))
        ...
        try:
            # Sound emotion model
            checkpoint = torch.load('Final_Models/sound_emotion_model.pth', map_location=DEVICE)
        ...
        try:
            # Prosody model
            checkpoint = torch.load('Final_Models/prosody_net_best.pth', map_location=DEVICE)
